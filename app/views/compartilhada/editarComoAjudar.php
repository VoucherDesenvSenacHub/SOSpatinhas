...
<section class="pontoArrecadacao">
    ...
    <div class="imgPontoArrecadacao">
      ...
      <div class="ruaIcone">
        <p class="endereco">
          ...
          <img src="/sospatinhas/public/images/icons/iconEditar.png" alt="Editar" class="iconeAcao">  
        </p>
      </div>
    </div>
  ...
  <section class="infoPixECards">
    <div class="infoValores">
      ...
      <div class="cards">
        <div class="card">
          <img src="/sospatinhas/public/images/icons/iconEditar.png" alt="Editar" class="iconEdit">

          <img src="/sospatinhas/public/images/iconeTalher.png" alt="Ícone de talher">
          <div>
        ...
        <div class="card">
          ...
          <img src="/sospatinhas/public/images/iconeLimpeza.png" alt="Ícone de Limpeza">
          <div>
        ...
        <div class="card">
          ...
          <img src="/sospatinhas/public/images/iconeConforto.png" alt="Ícone de Conforto">
          <div>
        ...
        <div class="card">
          ...
          <img src="/sospatinhas/public/images/iconeMedico.png" alt="Ícone de Médico">
          <div>
        ...
        <div class="card">
          ...
          <img src="/sospatinhas/public/images/iconeAtendimento.png" alt="Ícone de Atendimento">
          <div>
        ...
        <div class="card">
          ...
          <img src="/sospatinhas/public/images/iconeVacina.png" alt="Ícone de Vacina">
          <div>
    ...
    <div class="fundoQrCode"> 
      <div class="qrCode">
        <h2>
          ...
          <img src="/sospatinhas/public/images/icons/iconEditar.png" alt="Editar" class="iconEditPix">
          <!--
        ...
        <div id="logoBb">
          Conta: 198655-4
          <img id="imgLogoBanco" src="/sospatinhas/public/images/banco.png" alt="Imagem da logo do banco">
        </div>
