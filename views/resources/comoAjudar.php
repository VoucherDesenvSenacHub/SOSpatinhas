...
<body>
  ...
  <section class="pontoArrecadacao">
      <div id = "imagemEndereco">
        <img src="C:\xampp\htdocs\SOSpatinhas\views\images\valinhos07 1.png" alt="Imagem da ONG Sos Patinhas" style="width: 453px; height: 283px;">
        <p>R. do Parque, 75 - Centro, Campo Grande - MS</p>
      </div>
  
      <div class="pontoArrecadacaoText">
        <h2>Ponto de Arrecadação</h2>
        <p>"Seu gesto de doação é o elo que une corações humanos e patas amigas, criando um mundo mais compassivo para todos."</p>
      </div>
  </section>
  <section class="corpo container">
    

    <section id = "pixEValores">
